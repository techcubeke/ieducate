...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('subjectID, title', 'required'),
			...
			array('bookID, subjectID, title, ISBN, author, price, publisher, edition, issuable, volume, status, dateadded, datemodified', 'safe', 'on'=>'search'),
		);
	}
