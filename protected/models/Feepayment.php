...
class Feepayment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('feereceiptID, financialyearID', 'numerical', 'integerOnly'=>true),
			...
			array('feepaymentID, feereceiptID, financialyearID, paymentdate, paymentmode, paidamount, adjustedamount, chequedate, chequenumber, bankbranch, remarks, dateadded', 'safe', 'on'=>'search'),
		);
	}
